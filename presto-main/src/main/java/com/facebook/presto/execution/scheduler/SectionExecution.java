...
{
    private final StageExecutionAndScheduler rootStage; // 根阶段
    private final List<StageExecutionAndScheduler> allStages; // 所有阶段
    @GuardedBy("this")
    private volatile boolean aborted; // 是否已经终止
